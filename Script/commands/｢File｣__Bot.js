...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "Hi") || (event.body.toLowerCase() == "Hlw") ||(event.body.toLowerCase() == "হাই") || (event.body.toLowerCase() == "হ্যালো")) {
   ...
   if ((event.body.toLowerCase() == "🤣") || (event.body.toLowerCase() == "lol")) {
     return api.sendMessage("হাসি তোর মার ভোদা দিয়ে দিলো খানকির পোলা 🥵🥱👀", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Akash ") || (event.body.toLowerCase() == "Nobab ") || (event.body.toLowerCase() == "@Nobab Xhowdhury") || (event.body.toLowerCase() == "আকাশ")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:AKASH BOSS ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস আকাশ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami Akash") || (event.body.toLowerCase() == "cup sala ami Akash") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "@মাস্টার মশাই──😘😈🪼🩶🪽 ") || (event.body.toLowerCase() == "মাহিম")) {
     return api.sendMessage("🥰-মাহিম-🌺 আমার বস আকাস'এর বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে গার্লফ্রেন্ড টা আমার বস আকাশ এর দিয়ে দে..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>তেরা পাপ্পা 😆🥱💀", threadID);
   };
